...
<html>
    ...
    <body>
		<div id="st_main" class="st_main">
			<img src="bg1.png" alt="" class="st_preview" style="display:none;"/>
			<div class="st_overlay"></div>
			<h1>Vivian's photo album</h1>
			<div id="st_loading" class="st_loading"><span>Loading...</span></div>
			<ul id="st_nav" class="st_navigation">
				<li class="album">
					<span class="st_link">Wedding Dress<span class="st_arrow_down"></span></span>
					<div class="st_wrapper st_thumbs_wrapper">
						...
						<?php
								...
								while (sizeof($string) != 0){
									...
									echo "<img src='$filePath$img' width='180px' height='120px' alt=$filePath$img>";
								}
						?>
